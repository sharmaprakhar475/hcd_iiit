            ...
            <div class="row px-md-4 d-md-flex align-items-center justify-content-between" style="height: 30px;">
                ...
                <ul class="list-unstyled" style="width: 150px;">
                    <li class="d-flex align-items-center justify-content-between">
                        <a aria-label="twitter hcd" rel='noopener noreferrer' href="https://twitter.com/hcdiiitd" class="text-decoration-none" target="_blank">
                        ...
                        <a aria-label="facebook hcd" rel='noopener noreferrer' href="https://www.facebook.com/hcdiiitd" class="text-decoration-none mb-1" target="_blank">                    
                        ...
                        <a aria-label="linkedin hcd" rel='noopener noreferrer' href="https://www.linkedin.com/company/hcdiiitd/?viewAsMember=true" class="text-decoration-none" target="_blank">
            ...
            <div class="col-8 border" style="background-color: #E1E1E1; border-radius: 15px; border-color: rgb(161, 161, 161) !important;">
                ...
                <li class="list-unstyled mt-5 pb-2">
                    <ul class="d-flex text-center align-items-end flex-column h-100 mt-2 mb-0" style="list-style: none;">
                        ...
                        <li class="w-100 mt-1">
                            <a rel='noopener noreferrer' href="https://twitter.com/hcdiiitd" class="text-decoration-none" target="_blank">
                                <img src="/static/images/twitter_svg.svg" height="40">
                            </a>
                            <a rel='noopener noreferrer' href=" https://www.facebook.com/hcdiiitd" class="text-decoration-none" target="_blank">
                                <img src="/static/images/facebook_hcd.svg" height="40">
                            </a>
                            <a rel='noopener noreferrer' href="https://www.linkedin.com/company/hcdiiitd/?viewAsMember=true" class="text-decoration-none" target="_blank">
                                <img src="/static/images/linkedin_hcd.svg" height="40">
                            </a>
                            <a rel='noopener noreferrer' href="https://www.instagram.com/hcdiiitd/" class="text-decoration-none" target="_blank">
                                <img src="/static/images/insta_svg.svg" height="40">
                            </a>
                        </li>
                    </ul>
                </li>
